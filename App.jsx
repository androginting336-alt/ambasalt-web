                      ...
                      <div className="p-4">
                         <div className="grid grid-cols-2 gap-px bg-stone-800/50 border border-stone-800 rounded mb-4 overflow-hidden">
                           <div className="bg-stone-900/80 p-3">
                             ...
                             <span className="text-sm text-stone-300">{m.opticalProps?.relief}</span>
                           </div>
                           <div className="bg-stone-900/80 p-3">
                             <span className="block text-[10px] uppercase text-stone-500 font-bold mb-1">Birefringence</span>
                             <span className="text-sm text-amber-200/90">{m.opticalProps?.birefringence}</span>
                           </div>
                           <div className="bg-stone-900/80 p-3">
                             <span className="block text-[10px] uppercase text-stone-500 font-bold mb-1">Pemadaman</span>
                             <span className="text-sm text-stone-300">{m.opticalProps?.extinction}</span>
                           </div>
                           <div className="bg-stone-900/80 p-3">
                             <span className="block text-[10px] uppercase text-stone-500 font-bold mb-1">Pleokroisme</span>
                             <span className="text-stone-300 text-sm">{m.opticalProps?.pleochroism}</span>
                           </div>
                        </div>
